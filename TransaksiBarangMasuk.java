...
//	label txfield Barang Masuk
	...
	JLabel LNmSup		= new JLabel("Nama Supplier");
	...
	JLabel LStkMasuk 	= new JLabel("Stok Masuk");
...
//		panel header
		...
		pHeader.add(LNmSup);
		LNmSup.setFont(new Font("Calibri", Font.PLAIN, 14));
		LNmSup.setBounds(360, 58, 118, 14);
		pHeader.add(cbSup);
...
//   hapus tabel	
	...
	public static void main(String[] Yoona) {
		TransaksiBarangMasuk TBM = new TransaksiBarangMasuk();
		TBM.KomponenVisual();
		TBM.AksiReaksi();
	}
